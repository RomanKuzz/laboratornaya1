...
public class Calculator {
    ...
    public LinkedHashMap<String, Double[]> lhm = new LinkedHashMap<>(); //запись вычислений в хеш-таблицу

    public LinkedHashMap<String, Double[]> getLhm() {
        return lhm; //возврат метода lhm
    }
    ...
    public void calculations(double[][] arr) {
        geom(arr);
        mean(arr);
        variance(arr);
        range(arr);
